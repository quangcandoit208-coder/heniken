...
export default async function handler(_req: any, res: any) {
  try {
    const totalCampaignsRange = process.env.GOOGLE_TOTAL_CAMPAIGNS_RANGE || 'TotalCampaigns!A:L';
    const activationRange = process.env.GOOGLE_ACTIVATION_RANGE || 'Activation!A:U';
